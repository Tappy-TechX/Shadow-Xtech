...
async (conn, mek, m, {
    ...
    try {
        ...
        if (!/^\d+$/.test(countryCode)) {
            return reply("*🔴 Invalid country code. Provide only numbers (e.g., 92 for +92 numbers)*");
        }
        ...
        reply(`*✔️ Successfully removed ${targets.length} member(s) with country code +${countryCode}*`);
