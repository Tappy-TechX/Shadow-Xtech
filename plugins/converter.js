...
cmd({
    ...
    if (!message.quoted) {
        return await client.sendMessage(from, {
            text: "*_🔴 Please reply to a sticker message_*\n\n*_🫟 Example: `.convert` (reply to sticker)_*"
        }, { quoted: message });
    }

    if (message.quoted.mtype !== 'stickerMessage') {
        return await client.sendMessage(from, {
            text: "*_🔴 Only sticker messages can be converted_*"
        }, { quoted: message });
    }
    ...
    try {
        ...
        await client.sendMessage(from, {
            text: "*_🔴 Please try with a different sticker._*"
        }, { quoted: message });
    }
});
...
cmd({
    ...
    if (!['videoMessage', 'audioMessage'].includes(match.quoted.mtype)) {
        return await client.sendMessage(from, {
            text: "*_🔴 Only video/audio messages can be converted_*"
        }, { quoted: message });
    }
    ...
    try {
        ...
        await client.sendMessage(from, {
            text: "*_🔴 Failed to process audio_*"
        }, { quoted: message });
    }
});
...
cmd({
    ...
    try {
        ...
        await client.sendMessage(from, {
            text: "*_🔴 Failed to create voice message_*"
        }, { quoted: message });
    }
});
