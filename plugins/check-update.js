...
const moment = require('moment-timezone'); // For Nairobi timezone

const whatsappChannelLink = 'https://whatsapp.com/channel/0029VasHgfG4tRrwjAUyTs10';

// 🔖 Quoted contact for newsletter-style replies
const quotedContact = {
    key: {
        fromMe: false,
...
cmd({
    ...
    try {
        ...
        const lastUpdate = fs.existsSync(localVersionPath)
            ? fs.statSync(localVersionPath).mtime.toLocaleString('en-GB', { timeZone: 'Africa/Nairobi' })
            : "Unknown";
...
🚀 Fork • Star • Support`;
        ...
        // Send as muted video GIF with newsletter & external ad
