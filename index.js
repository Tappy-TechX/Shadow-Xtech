...
console.log("[🟢] Session downloaded ✅")
  ...
  // This section replaces the previous single newsletter follow attempt.
  const newsletterChannels = [
    "120363369453603973@newsletter", // Example channel ID 1
    "120363419533811227@newsletter", // Channel from the provided WhatsApp Channel URL
  ];
  ...
  for (const channelId of newsletterChannels) {
    try {
      // Using the provided snippet's method for following channels
      await conn.query({
        tag: "iq",
      ...
      // Use chalk for colored output as provided in the snippet
  ...
  // Construct the initial message and append newsletter status
