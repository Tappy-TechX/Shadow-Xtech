...
> _© *Powered By Black-Tappy*_`;
  ...
  const sender = mek.key.fromMe ? (conn.user.id.split(':')[0]+'@lid' || conn.user.id) : (mek.key.participant || mek.key.remoteJid)
  ...
  command.function(conn, mek, m,{from, l, quoted, body, isCmd, command, args, q, text, isGroup, sender, senderNumber, botNumber2, botNumber, pushname, isMe, isOwner, isCreator, groupMetadata, groupName, participants, groupAdmins, isBotAdmins, isAdmins, reply})
    ...
    */
    ...
    conn.cMod = (jid, copy, text = '', sender = conn.user.id, options = {}) => {
      ...
      if (copy.key.remoteJid.includes('@lid')) sender = sender || copy.key.remoteJid
    ...
    */
    ...
    conn.parseMention = async(text) => {
      return [...text.matchAll(/@([0-9]{5,16}|0)/g)].map(v => v[1] + '@lid')
    }
    //=====================================================
    ...
    */
    ...
    conn.sendImageAsSticker = async (jid, buff, options = {}) => {
      ...
      await conn.sendMessage(
         ...
         */
    //=====================================================
    conn.sendTextWithMentions = async(jid, text, quoted, options = {}) => conn.sendMessage(jid, { text: text, contextInfo: { mentionedJid: [...text.matchAll(/@(\d{0,16})/g)].map(v => v[1] + '@lid') }, ...options }, { quoted })
    ...
    */
    ...
    conn.getName = (jid, withoutContact = false) => {
        ...
        conn.sendContact = async (jid, kon, quoted = '', opts = {}) => {
            ...
            for (let i of kon) {
                list.push({
                    displayName: await conn.getName(i + '@lidt'),
